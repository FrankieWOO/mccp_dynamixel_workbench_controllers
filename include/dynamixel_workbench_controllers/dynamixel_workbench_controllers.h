...
#include <dynamixel_workbench_msgs/DynamixelCommandTwo.h>
#include <dynamixel_workbench_msgs/Dxlcmd2.h>
...
class DynamixelController
{
 private:
  ...
  ros::Subscriber dxlcmd2_sub_;

  // ROS Service Server
  ros::ServiceServer dynamixel_command_server_;
  ros::ServiceServer dynamixel_command_server2_;
 ...
 public:
  ...
  void dxlcmd2MsgCallback(const dynamixel_workbench_msgs::Dxlcmd2 &msg);
  bool dynamixelCommandMsgCallback(dynamixel_workbench_msgs::DynamixelCommand::Request &req,
                                   dynamixel_workbench_msgs::DynamixelCommand::Response &res);
  bool dynamixelCommandTwoMsgCallback(dynamixel_workbench_msgs::DynamixelCommandTwo::Request &req,
